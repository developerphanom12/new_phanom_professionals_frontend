    ...
    <Root>
      <div className="container-fluid">
        <div className="row">
          ...
          >
            <span>How to </span>
            <span className="text"> Get </span> <span>Started</span>
          </div>
          <div className="col-lg-2 col-md-12 col-12"></div>
        </div>
        <div className="row">
          <div className="col-lg-3 col-md-6 col-12 block_main">
            <div className="block_div">
              ...
              <div className="tag_text">
                <p>Reach Out</p>
                <span>
                Contact us to schedule an initial consultation. We’re eager to learn about your project and discuss how we can assist you.
                </span>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 block_main">
            <div className="block_div">
              ...
              <div className="tag_text">
                ...
                <span>
                Provide details about your website goals, design preferences, and any specific features you need. This helps us understand your requirements.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-12 block_main">
            <div className="block_div">
              ...
              <div className="tag_text">
                ...
                <span>
                We’ll provide a detailed proposal outlining the project scope, timeline, and costs.
                </span>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 block_main">
            <div className="block_div">
              ...
              <div className="tag_text">
                <p>Start the Design Process</p>
                <span>
                Once you approve the proposal, our team will begin working on your website, keeping you updated throughout the process.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-12 block_main">
            <div className="block_div">
              ...
              <div className="tag_text">
                ...
                <span>
                After a thorough review and testing phase, we’ll launch your website and provide ongoing support as needed.
