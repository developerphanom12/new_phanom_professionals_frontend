        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 block_main">
            <div className="block_div">
              <p>Proven Excellence in Design</p>
              <span>
                <b>Over 1,000 Projects Completed:</b> Our extensive portfolio
                speaks volumes. From startups to global brands, our UI/UX
                designs have transformed over 1,000 digital products.
              </span>
              <span>
                <b>Rated 4.9/5:</b> Clients consistently rate us highly,
          ...
          <div className="col-lg-4 col-md-6 col-12 block_main">
            <div className="block_div">
              ...
              <span>
                <b>Simple Three-Step Process:</b>
              </span>
              <span>
                <b>Define Your Needs: </b>Share your project requirements and
                objectives.
              </span>
              <span>
                <b>Meet Our Experts: </b>Explore our curated list of in-house
                UI/UX designers.
              </span>
              <span>
                <b>Hire the Perfect Fit: </b>Select the designer who best aligns
          ...
          <div className="col-lg-4 col-md-12 col-12 block_main">
            <div className="block_div">
              <p>Risk-Free Trial</p>
              <span>
                <b>Experience Before Committing:</b> Enjoy a risk-free trial
                period to evaluate our designers’ capabilities and ensure they
        ...
        <div className="row">
          <div className="col-lg-4 col-md-12 col-12 block_main">
            <div className="block_div">
              <p>Cost Efficiency</p>
              <span>
                <b>Save Up to 50%:</b> By partnering with Phanom Professionals,
                you can significantly cut down your design costs without
                compromising on quality. Our competitive pricing ensures that
                you get top-notch design talent at a fraction of the cost.
              </span>
            </div>
          </div>
