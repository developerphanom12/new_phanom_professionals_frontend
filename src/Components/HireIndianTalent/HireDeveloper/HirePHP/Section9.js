      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <span> Expertise</span>
            <p className="mt-3">Our team at Phanom Professionals has extensive experience delivering PHP solutions across various industries. Here’s how we cater to different sectors:</p>
          </div>
        </div>
        <div className="row">
