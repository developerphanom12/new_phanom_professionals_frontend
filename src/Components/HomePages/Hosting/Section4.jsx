...
import hostingthree from "../../assets copy/Images/hostnewthree.png";

import hostfive from "../../assets copy/Images/hostnewfive.png";

import hosttwo from "../../assets copy/Images/hostnewtwo.png";

import hostfour from "../../assets copy/Images/hostnewfour.png";
    ...
    <Root>
      <div className="main_div">
        <div className="sub_main_div">
          ...
          <img src={hostingthree} alt="Vertical" className="ist_image"/>
          ...
          <img src={hostfive} alt="Vertical " className="ist_image" />
        </div>

        <div className="sub_main_div">
          <img src={hosttwo} alt="Vertical" className="sec_image" />
          ...
          <img src={hostfour} alt="Vertical" className="sec_image" />
