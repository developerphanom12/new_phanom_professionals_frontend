...
export const AdminBlog = () => {
  ...
  const deleteBlog = async (id) => {
    try {
      const res = await axios.put(`${EXCHANGE_URLS_BUYER}/deleteblogs/${id}`);
      if (res.status === 200) {
  ...
  return (
    <Root>
      ...
      <div className="heading">
        ...
        <button onClick={() => navigate(`/upload-blog`)}>Upload</button>
      </div>
        ...
        <div className="blog_div">
          ...
          blogsData.length > 0 ? (
            blogsData?.map((i, index) => (
              ...
              >
                <a
                  href={`/blog-details/${i.id}/${generateSlug(i.slug)}`}
                  onClick={(e) => handleBlogClick(e, i?.id, i.slug)}
                ...
                <div className="actions">
                  ...
                  >
                    ...
                    <a href={`/edit-blog/${i?.id}`} onClick={() => handleEditClick(i?.id)}>
