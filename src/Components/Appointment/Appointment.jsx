...
import { InputModalGreyLabel, InputModalLabel, InputModalTextarea, InputModalType, SelectModalBorder } from "../../Global/GlobalFormElement";
import DatePicker from "react-datepicker";
          ...
          <div className="main_div">
            ...
            <form>
              ...
              <div className="btn_div">
                <WhiteBgBackground onClick={handleClose}>
                  Cancel
                </WhiteBgBackground>
                <PurpleBgBackground>Submit</PurpleBgBackground>
              </div>
